"""Comprueba la cobertura de unidades, armas, manifestaciones y alias visibles.
...
PROFILE_TYPES = {'Unit', 'Melee Weapon', 'Ranged Weapon', 'Manifestation'}
...
def required_names():
    ...
    for source, root in trees:
        for e in root.iter():
            kind = tag(e)
            is_profile = kind == 'profile' and e.get('typeName') in PROFILE_TYPES
